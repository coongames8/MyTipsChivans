...
export default function PaymentPage({ setUserData }) {
    ...
    const subscriptionPlans = {
        ...
        crypto: [
            ...
            { id: "16", value: 16, label: "Monthly", price: "$16" },
    ...
    const paystackConfig = {
        ...
        email: currentUser.email,
        amount: price * 100,
        publicKey: 'pk_live_d1d1b5057c1240a906852cd3ffbea3a0a581dc72',//pk_live_1f52ac2c68e29c12c4d15132533fdfc95cebb09fpk_live_d1d1b5057c1240a906852cd3ffbea3a0a581dc72
        currency: "KES",
